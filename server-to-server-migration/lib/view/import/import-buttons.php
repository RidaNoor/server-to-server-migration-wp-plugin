<?php if ( is_readable( S2SM_STORAGE_PATH ) && is_writable( S2SM_STORAGE_PATH ) ) :  ?>
	<div class="s2sm
-import-messages"></div>
...
-icon-cloud-upload"></i><br />
						<?php _e( 'Drag & Drop to upload', S2SM_PLUGIN_NAME ); ?>
					</p>
					<div class="s2sm
-button-group s2sm
-button-import s2sm
-expandable">
						<div class="s2sm
-button-main">
							<span><?php _e( 'Import From', S2SM_PLUGIN_NAME ); ?></span>
...
-label">
					<i class="s2sm
-icon-notification"></i>
					<?php _e( 'Get unlimited', S2SM_PLUGIN_NAME ); ?>
				</a>
			</span>
		<?php else : ?>
			<span class="s2sm
-max-upload-size"><?php _e( 'Unlimited', S2SM_PLUGIN_NAME ); ?></span>
		<?php endif; ?>
	</p>
<?php else : ?>
	<div class="s2sm
