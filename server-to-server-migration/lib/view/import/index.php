...
-holder">
				<h1><i class="s2sm
-icon-publish"></i> <?php _e( 'Import Site', S2SM_PLUGIN_NAME ); ?></h1>
...
-clear" enctype="multipart/form-data">
					...
					<p>
						<?php _e( 'Use the box below to upload a wpress file.', S2SM_PLUGIN_NAME ); ?><br />
					</p>

					<?php include S2SM_TEMPLATES_PATH . '/import/import-buttons.php'; ?>
