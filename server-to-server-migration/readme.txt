...
Server-to-Server Migration is the only tool that you will ever need to migrate a WordPress site.
...
Server to Server Migration Plugin is the first plugin to offer true mobile experience on WordPress versions 3.3 and up.
...
* 1&1
* Pantheon
* [See the full list of supported providers here](https://help.migzara.com/knowledgebase/supported-hosting-providers/)

= Migrate WordPress to most popular cloud services using our completely new extensions =
* [Unlimited](https://migzara.com/products/unlimited-extension)
* [Dropbox](https://migzara.com/products/dropbox-extension)
* [Multisite](https://migzara.com/products/multisite-extension)
* [FTP](https://migzara.com/products/ftp-extension)
* [Google Drive](https://migzara.com/products/google-drive-extension)
* [Amazon S3](https://migzara.com/products/amazon-s3-extension)
* [URL](https://migzara.com/products/url-extension)
* [OneDrive](https://migzara.com/products/onedrive-extension)
* [Box](https://migzara.com/products/box-extension)
* And many more to come

= Contact us =
* [Get free help from us here](https://migzara.com/help)
* [Report a bug or request a feature](https://migzara.com/help)
* [Find out more about us](https://migzara.com)
...
== Installation ==
1. Upload the `server-to-server-migration` folder to the `/wp-content/plugins/` directory
1. Activate the Server to Server Migration Plugin through the 'Plugins' menu in WordPress
...
* Add separate action hook in advanced settings called "s2sm_export_advanced_settings" to allow custom checkbox options on export
...
* Add "s2sm_exclude_content_from_export" WordPress hook on export
* Add HTML5 uploader
...
= 3.0.0 =
* Added export to File, [Dropbox](https://migzara.com/products/dropbox-extension), [Amazon S3](https://migzara.com/products/amazon-s3-extension), [Google Drive](https://migzara.com/products/google-drive-extension)
* Added import from File, [Dropbox](https://migzara.com/products/dropbox-extension), [Amazon S3](https://migzara.com/products/amazon-s3-extension), [Google Drive](https://migzara.com/products/google-drive-extension)
