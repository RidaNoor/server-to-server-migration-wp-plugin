...
* Add separate action hook in advanced settings called "s2sm
_export_advanced_settings" to allow custom checkbox options on export
...
* Add "s2sm
_exclude_content_from_export" WordPress hook on export
* Add HTML5 uploader
