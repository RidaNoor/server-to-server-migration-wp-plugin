...
class S2sm_Updater_Controller {

	public static function plugins_api( $result, $action = null, $args = null ) {
		return S2sm_Updater::plugins_api( $result, $action, $args );
	}
	...
	public static function update_plugins( $transient ) {
		return S2sm_Updater::update_plugins( $transient );
	}

	public static function check_for_updates() {
		return S2sm_Updater::check_for_updates();
	}

	public static function plugin_row_meta( $links, $file ) {
		return S2sm_Updater::plugin_row_meta( $links, $file );
	}
	...
	public static function updater() {
		...
		// Set uuid
		$uuid = null;
		if ( isset( $_POST['s2sm_uuid'] ) ) {
			$uuid = trim( $_POST['s2sm_uuid'] );
		}

		// Set extension
		$extension = null;
		if ( isset( $_POST['s2sm_extension'] ) ) {
			$extension = trim( $_POST['s2sm_extension'] );
		}
