...
_Export_Config {
	...
	public static function execute( $params ) {
		...
		// Set progress
		S2sm
_Status::info( __( 'Adding configuration to archive...', S2SM
_PLUGIN_NAME ) );
...
_cache_flush();
		...
		// Set plugin version
		$config['Plugin'] = array( 'Version' => S2SM
_VERSION );
...
_package_path( $params ), S2SM
_PACKAGE_NAME );
		$archive->close();

		// Set progress
		S2sm
_Status::info( __( 'Done adding configuration to archive.', S2SM
_PLUGIN_NAME ) );
