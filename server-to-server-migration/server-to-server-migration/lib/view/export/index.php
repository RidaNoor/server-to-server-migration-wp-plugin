...
-holder">
				<h1><i class="s2sm
-icon-export"></i> <?php _e( 'Export Site', S2SM
_PLUGIN_NAME ); ?></h1>
...
-clear">
					...
					<?php include S2SM
_TEMPLATES_PATH . '/export/find-replace.php'; ?>

					<?php do_action( 's2sm
_export_left_options' ); ?>

					<?php include S2SM
_TEMPLATES_PATH . '/export/advanced-settings.php'; ?>

					<?php include S2SM
_TEMPLATES_PATH . '/export/export-buttons.php'; ?>
