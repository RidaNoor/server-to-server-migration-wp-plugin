...
/***/ function(module, exports, __webpack_require__) {
	...
	jQuery(document).ready(function ($) {
		...
		$('.s2sm
-backup-actions > a').hover(function () {
			$(this).addClass('s2sm
-button-on');
		}, function () {
			$(this).removeClass('s2sm
-button-on');
		});

		// Delete file
		$('.s2sm
-backup-delete').click(function (e) {
			var self = $(this);
...
_backups.ajax.url,
					...
					success: function success(result) {
						...
						if (errors.length === 0) {
							...
							if ($('.s2sm
-backups tbody tr').length === 0) {
								$('.s2sm
-backups').addClass('s2sm
-hide');
								$('.s2sm
-backups-empty').removeClass('s2sm
-hide');
							}
						}
					},
		...
		// Restore from file
		$('.s2sm
-backup-restore').click(function (e) {
			var storage = Util.random(12);
			var options = Util.form('#s2sm
-backups-form').concat({ name: 'storage', value: storage }).concat({ name: 'archive', value: $(this).data('archive') });
